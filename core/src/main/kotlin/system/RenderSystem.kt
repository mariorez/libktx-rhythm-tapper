...
class RenderSystem(
    ...
    private val targetBoxMapper: ComponentMapper<TargetBoxComponent>
) : IteratingSystem(
    ...
    override fun onTickEntity(entity: Entity) {
        ...
        targetBoxMapper.getOrNull(entity)?.let { targetBox ->
            targetBox.label.apply {
                setPosition(
                    transformMapper[entity].position.x,
                    transformMapper[entity].position.y
                )
                draw(batch, 1f)
            }
        }
